...
function lgraph = createUnet(inputTileSize, numClasses)
...
finalConv.Weights = randn(1,1,decoderNumChannels,numClasses);
finalConv.Bias = randn(1,1,numClasses)*0.00001 + 1;
